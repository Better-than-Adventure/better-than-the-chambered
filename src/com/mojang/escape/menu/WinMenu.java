...
public class WinMenu extends Menu {
	...
	public void render(Bitmap target) {
		target.draw(Art.INSTANCE.getLogo(), 0, 10, 0, 65, 160, 23, Art.INSTANCE.getCol(0xffffff));
		...
		timeString += seconds;
		target.draw("Trinkets: " + player.loot + "/12", 40, 45 + 10 * 0, Art.INSTANCE.getCol(0x909090));
		target.draw("Time: " + timeString, 40, 45 + 10 * 1, Art.INSTANCE.getCol(0x909090));
