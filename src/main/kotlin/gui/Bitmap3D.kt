...
class Bitmap3D(width: Int, height: Int): Bitmap(width, height) {
    ...
    private fun renderSprite(x: Double, y: Double, z: Double, tex: Int, color: Int) {
    ...
    private fun renderWall(x0: Double, y0: Double, x1: Double, y1: Double, tex: Int, color: Int) {
        renderWall(x0, y0, x1, y1, tex, color, 0.0, 1.0)
    }

    private fun renderWall(x0: Double, y0: Double, x1: Double, y1: Double, tex: Int, color: Int, xt0: Double, xt1: Double) {
